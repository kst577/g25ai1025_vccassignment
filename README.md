...
- **monitor.py** — Same landing page as the cloud app; I kept it as a separate script for the monitoring part of the assignment.
...
`cloud_app.py` and `monitor.py` use port 80. On the Linux VM that’s normal. On your own Mac, port 80 often needs admin rights, so for day-to-day testing I mostly use **app.py** on 5000.

## Repo link

https://github.com/kst577/g25ai1025_vccassignment
